...
const deviceSignalStore = new AsyncLocalStorage<AbortSignal | undefined>();

/** 在「可取消的设备操作」上下文里执行 fn。 */
export function withDeviceSignal<T>(signal: AbortSignal | undefined, fn: () => Promise<T>): Promise<T> {
